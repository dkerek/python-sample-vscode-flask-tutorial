[![Build Status](https://davidkerek.visualstudio.com/Learn/_apis/build/status/dkerek.python-sample-vscode-flask-tutorial?branchName=master)](https://davidkerek.visualstudio.com/Learn/_build/latest?definitionId=4&branchName=master)
